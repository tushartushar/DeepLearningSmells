...
def get_data(data_path, out_folder, case_string, train_validate_ratio = 0.7, max_training_samples = 5000):
    gc.collect()
...
def get_data_rq2(training_data_path, eval_data_path, out_folder, case_string, train_validate_ratio = 0.7, max_training_samples = 5000):
    gc.collect()
        ...
        with open(os.path.join(path, file), 'r', errors='ignore') as f:
            ...
            for line in f:
                ...
                if (input_str == "\n" or input_str == ""): #end of current sample
                    ...
                    if is_valid and no_of_lines < max_input_height and no_of_lines > 0:
